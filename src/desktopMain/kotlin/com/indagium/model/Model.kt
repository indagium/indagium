...
data class Annotations(
    ...
    // "similar past issues" retrieval (com.indagium.cases). Persisted (.ann sidecar + autosave) as
 ...
 * from [com.indagium.ui.DesktopStorage.voiceModelsDir], so no machine-specific model path is saved. */
...
data class AppSettings(
    ...
    // AI/MCP via get_project_info (IndagiumToolOperations.getProjectInfoRoute). Trailing with a
