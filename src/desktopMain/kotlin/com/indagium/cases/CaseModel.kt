 ...
 *  [CaseIndex] stale — mirrors [com.indagium.source.SOURCE_INDEX_VERSION]'s role for the source
...
data class CaseRecord(
    ...
    // index 5) — empty when never detected/set. See com.indagium.utils.extractAppVersionHeuristic.
 ...
 *  a token-cheap [CaseSummary] (mirrors [com.indagium.source.SourceMatch]). */
