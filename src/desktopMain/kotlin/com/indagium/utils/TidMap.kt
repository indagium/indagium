 ...
 *  [colorKey] is [entry.tid][com.indagium.model.LogEntry.tid] — distinct THREADS of the target's
 ...
 *  `[ac, seq2, seq1]`[com.indagium.ui.ThemeColors] instead (see AppState.toggleTidMap) — `ac` first
 ...
 *  [TidMapState.colors][com.indagium.model.TidMapState] by AppState.toggleTidMap so every panel's
