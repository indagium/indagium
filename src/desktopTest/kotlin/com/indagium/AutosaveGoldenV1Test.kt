 ...
 *
 * The fixture was produced once by building a real [AppState] with every [com.indagium.model.AppSettings]
...
class AutosaveGoldenV1Test {
    ...
    fun v1GoldenDecodesSettingsSavedFiltersAndSessionMetadataLosslessly() {
        ...
        assertEquals(
            listOf(com.indagium.model.CopyMaskRule("java", "j*ava"), com.indagium.model.CopyMaskRule("secret", "s3cret")),
            s.copyMaskRules,
        )
        ...
        assertEquals(setOf(com.indagium.model.LogLevel.I, com.indagium.model.LogLevel.W, com.indagium.model.LogLevel.E), crashTriage.levels)
        ...
        assertEquals(com.indagium.model.LogLevel.entries.toSet(), networkOnly.levels)
