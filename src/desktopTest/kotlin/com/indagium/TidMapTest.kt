...
import com.indagium.model.TidMapTarget
import com.indagium.ui.SEQ_COLORS
import com.indagium.utils.TidMapBranch
import com.indagium.utils.assignTidMapColors
import com.indagium.utils.computeTidMapBranches
import com.indagium.utils.computeTidMapColors
import com.indagium.utils.findTidMapSpan
import com.indagium.utils.tidMapHighlightedEntryRange
...
class TidMapTest {
    ...
    fun branchIndentComesFromTheItemsOwnIndentAndManualHeaderHasZeroIndent() {
        val manual = LogItem.ManualHeader(
            ...
            gid = "m_1",
            direction = com.indagium.model.ManualCollapseDirection.RANGE,
            expanded = false,
            count = 1,
            color = Color.Red,
        )
