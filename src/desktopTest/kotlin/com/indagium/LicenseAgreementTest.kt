...
import com.indagium.ui.LICENSE_VERSION
import com.indagium.ui.loadLicenseAgreement
...
class LicenseAgreementTest {
    ...
    private fun com.indagium.model.AppSettings?.orEmpty() = this ?: com.indagium.model.AppSettings()
}
