 ...
 * past issues" retrieval feature (com.indagium.cases), and `frameStamp` (field index 7) for the
...
class AnnotationsTokenTest {
    ...
    fun roundTripsVideoFrameIdentityLabelAndExactPosition() {
        ...
        assertEquals(original, restored)
        assertEquals("From bugreport.zip/FS/data/screen.mp4 @ 00:12.345", image.videoFrame?.provenanceLabel)
