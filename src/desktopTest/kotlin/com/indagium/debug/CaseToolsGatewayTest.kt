 ...
 * get_case, set_case_metadata, reindex_cases) through the real [IndagiumToolGateway] — the same
 ...
 * (see com.indagium.cases.CaseSearchTest for that).
 *
...
class CaseToolsGatewayTest {
    ...
    fun setCaseMetadataWritesOntoTheTabsAnnotationsThroughTheNormalMutationPath() {
        ...
        assertEquals(IndagiumToolActionPolicy.AUTOMATIC, operations.toolGateway.actionPolicy("set_case_metadata"))
    }
    ...
    fun reindexCasesIsAutomaticAndForcesAFullRebuild() {
        assertEquals(IndagiumToolActionPolicy.AUTOMATIC, operations.toolGateway.actionPolicy("reindex_cases"))
        assertEquals(IndagiumToolActionPolicy.AUTOMATIC, operations.toolGateway.actionPolicy("search_similar_cases"))
        assertEquals(IndagiumToolActionPolicy.AUTOMATIC, operations.toolGateway.actionPolicy("get_case"))
    ...
    fun theUiDialogAndThisToolOperationsInstanceShareOneCaseSearchNotTwo() {
        ...
        // file and duplicated parse work. IndagiumToolOperations.caseSearch now just delegates to
