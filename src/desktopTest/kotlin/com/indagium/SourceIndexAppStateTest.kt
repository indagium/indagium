...
import com.indagium.ui.linuxDesktopEditorTemplates
...
class SourceIndexAppStateTest {
        ...
        state.updateSettings {
            it.copy(
                ...
                sourceFolderInfo = mapOf(
                    "/a" to com.indagium.model.SourceFolderInfo("Main app", "/a/README.md"),
                    "/b" to com.indagium.model.SourceFolderInfo("Shared lib", null),
                ),
            )
        }
        state.autosaveNow()
    ...
    fun removeSourceFolderStripsItsInfoMapEntry() {
        ...
        state.updateSettings {
            it.copy(
                ...
                sourceFolderInfo = mapOf("/a" to com.indagium.model.SourceFolderInfo("Main app", null)),
            )
        }
    ...
    fun readMethodSourceReturnsNullForUnreadableFile() {
        ...
        val state = newState(dir)
        val site = com.indagium.source.LogCallSite(
