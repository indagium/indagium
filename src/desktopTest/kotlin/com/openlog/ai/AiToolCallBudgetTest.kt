...
class AiToolCallBudgetTest {
    ...
    fun managedMcpCallsShareTheRunBudgetAndRejectBeforeTheHandler() = runBlocking {
        ...
        val gateway = OpenLogToolGateway(
            listOf(OpenLogToolDescriptor("set_filter", "", ToolSchema(properties = buildJsonObject { }))),
    ...
    fun notesAndMetadataRemainAvailableAfterAnalysisBudgetIsExhausted() = runBlocking {
        ...
        val gateway = OpenLogToolGateway(
            listOf(
                OpenLogToolDescriptor("get_filter", "", ToolSchema(properties = buildJsonObject { })),
                OpenLogToolDescriptor("get_annotation_blocks", "", ToolSchema(properties = buildJsonObject { })),
                OpenLogToolDescriptor("add_text_note", "", ToolSchema(properties = buildJsonObject { })),
                OpenLogToolDescriptor("set_case_metadata", "", ToolSchema(properties = buildJsonObject { })),
            ),
            mapOf(
